...
#
# #
# # with open('positive (base).csv', 'r', encoding='utf-8') as file:
...
# #     with open('positive-tmp.csv', 'w', encoding='utf-8') as write:
# #         with open('positive-tmp.csv', 'r', encoding='utf-8') as read:
# #             pos_reader = csv.reader(read)
# #
# #
# #
# #
