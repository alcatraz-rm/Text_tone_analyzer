...
<br>Программа имеет графический интерфейс. В главном окне необходимо выбрать метод ввода текста (вручную или из файла) и метод вывода (на экран или в файл). Далее появится окно, считывающее всю необходимую информацию. Имена файлов следует вводить с расширением .txt
